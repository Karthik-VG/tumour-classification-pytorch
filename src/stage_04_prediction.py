...
def main(config_path):
    ...
    test_data_batches = content['params']['no_of_test_data_batches_for_prediction']
    prediction_dir = Path(content['Data']['predicted_data'])
    create_directories([prediction_dir])
    prediction_file = Path(content['Data']['predicted_data'], content['Data']['prediction_file'])
...
if __name__ == "__main__":
    ...
    try:
        main(config_path=parsed_arg.config)
